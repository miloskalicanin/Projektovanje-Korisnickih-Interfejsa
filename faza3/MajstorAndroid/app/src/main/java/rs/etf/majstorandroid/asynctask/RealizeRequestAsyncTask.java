...
public class RealizeRequestAsyncTask extends AsyncTask<Void, Void, Boolean> {

    private WeakReference<MainActivity> mainActivityWeakReference;
    private RequestInfoDTO request;
    private ProgressDialog dialog = null;

    public RealizeRequestAsyncTask(MainActivity mainActivity, RequestInfoDTO request) {
    ...
    protected void onPreExecute() {
        ...
        dialog = Utils.showProgressDialog(activity, activity.getString(R.string.dialog_loading_title), activity.getString(R.string.wait_for_realize_request));
    }
    ...
    protected void onPostExecute(Boolean result) {
        ...
        if (result == null || !result) {
            Toast.makeText(activity, R.string.realize_request_error_message, Toast.LENGTH_LONG).show();
        } else {
    ...
    private void displayDialog(final MainActivity activity) {
        ...
        builder.setTitle(activity.getString(R.string.realize_successful_title))
                .setMessage(activity.getString(R.string.realize_successful_message));
